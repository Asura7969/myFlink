...
public class PoolingHttpClient implements Serializable {

	private static final int DEFAULT_MAX_TOTAL_CONNECTIONS = 5;
	...
	private static final int DEFAULT_WAIT_TIMEOUT_MILLISECONDS = 1000;
	...
	public PoolingHttpClient() {
		...
		connManager.closeIdleConnections(30 * 1000,TimeUnit.SECONDS);
		...
		//staleMonitor = new IdleConnectionMonitorThread(connManager);
